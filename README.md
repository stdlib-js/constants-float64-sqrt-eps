...
```javascript
FLOAT64_SQRT_EPSILON = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-sqrt-eps@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var FLOAT64_SQRT_EPSILON = require( 'path/to/vendor/umd/constants-float64-sqrt-eps/index.js' )
```

...
```javascript
FLOAT64_SQRT_EPSILON = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-sqrt-eps@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-sqrt-eps@umd/bundle.js"></script>
```
